...
python combine_A_and_B.py --fold_A brats_pix2pix_shortened/A --fold_B brats_pix2pix_shortened/B --fold_AB brats_pix2pix_shortened_final --no_multiprocessing
python train.py --dataroot ./datasets/gazi_pix2pix_final --name gazi_pix2pix --model pix2pix --n_epochs 2000 --output_nc 1 --gpu_ids 0
python train.py --dataroot ./datasets/gazi_cyclegan --name gazi_cyclegan --model cycle_gan --n_epochs 2000 --output_nc 1 --gpu_ids 1


python train.py --dataroot ./datasets/brats_pix2pix_shortened_final --name gazi_pix2pix --model pix2pix --n_epochs 2000 --output_nc 1 --gpu_ids 0
python train.py --dataroot ./datasets/brats_cyclegan_shortened --name gazi_cyclegan --model cycle_gan --n_epochs 2000 --output_nc 1 --gpu_ids 1
