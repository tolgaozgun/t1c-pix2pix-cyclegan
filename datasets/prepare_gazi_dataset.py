...
def parse_images(flair_imgs, t1w_imgs, t2w_imgs, gadolinium_t1w_imgs, sub_no):
    ...
    if CREATE_SUB_FOLDERS: 
        cyclegan_sub_path = os.path.join(cyclegan_trainA_folder, sub_no)
        os.makedirs(cyclegan_sub_path, exist_ok=True)
        pix2pix_sub_path = os.path.join(pix2pix_trainA_folder, sub_no)
        os.makedirs(pix2pix_sub_path, exist_ok=True)
    ...
    for i in range(0, no_of_sequences):
        ...
        if CREATE_SUB_FOLDERS: 
            ...
            img_t1w_data.save(os.path.join(cyclegan_sub_path, f"{sub_no}_seq{i}_t1w.png"))
            img_t2w_data.save(os.path.join(cyclegan_sub_path, f"{sub_no}_seq{i}_t2w.png"))
            img_flair_data.save(os.path.join(cyclegan_sub_path, f"{sub_no}_seq{i}_flair.png"))

        img_A_data.save(os.path.join(cyclegan_trainA_folder, f"{sub_no}_seq{i}_A.png"))
        img_B_data.save(os.path.join(cyclegan_trainB_folder, f"{sub_no}_seq{i}_B.png"))

        # Create pix2pix dataset

        if CREATE_SUB_FOLDERS: 
            img_t1w_data.save(os.path.join(pix2pix_sub_path, f"{sub_no}_seq{i}_t1w.png"))
            img_t2w_data.save(os.path.join(pix2pix_sub_path, f"{sub_no}_seq{i}_t2w.png"))
            img_flair_data.save(os.path.join(pix2pix_sub_path, f"{sub_no}_seq{i}_flair.png"))

        img_A_data.save(os.path.join(pix2pix_trainA_folder, f"{sub_no}_seq{i}_A.png"))
        img_B_data.save(os.path.join(pix2pix_trainB_folder, f"{sub_no}_seq{i}_B.png"))
